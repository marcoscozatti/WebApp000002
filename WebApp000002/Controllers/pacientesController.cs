...
namespace WebApp000002.Controllers
{
    public class pacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome")] paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome")] paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
